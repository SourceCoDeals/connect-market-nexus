...
export function PendingSigningBanner() {
  ...
  return (
    <>
      <div className="rounded-lg border-2 border-sourceco/40 bg-sourceco-background p-4 mb-6">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-2 mt-3">
              {needsNda && (
                <Button
                  size="sm"
                  className="h-8 text-xs bg-sourceco hover:bg-sourceco/85 text-slate-900 font-medium"
              ...
              {needsFee && (
                <Button
                  ...
                  className={
                    needsNda
                      ? 'h-8 text-xs'
                      : 'h-8 text-xs bg-sourceco hover:bg-sourceco/85 text-slate-900 font-medium'
                  }
