...
const REFERRAL_SOURCES = [
  {
    ...
    followUpQuestion: 'Where did you see it?',
    placeholder: 'e.g., NYC Times Square, Highway 101',
  },
  {
    id: 'friend',
    label: 'Friends / Coworker',
    followUpQuestion: 'Who referred you? (optional)',
    placeholder: 'e.g., John from Acme Corp',
  },
  {
    id: 'google',
    label: 'Google',
    followUpQuestion: 'What were you searching for?',
    placeholder: 'e.g., M&A deal sourcing, business acquisition',
  },
  {
    id: 'twitter',
    label: 'X.com',
    followUpQuestion: 'Was it a post, ad, or thread?',
    placeholder: 'e.g., Post from @sourceco',
  },
  {
    id: 'instagram',
    label: 'Instagram',
    followUpQuestion: 'Was it a post, ad, or story?',
    placeholder: 'e.g., Sponsored ad',
  },
  {
    id: 'ai',
    label: 'AI',
    followUpQuestion: 'Which AI assistant?',
    placeholder: 'e.g., ChatGPT, Claude, Perplexity',
  },
  {
    id: 'newsletter',
    label: 'Newsletter',
    followUpQuestion: 'Which newsletter?',
    placeholder: 'e.g., Morning Brew, The Hustle',
  },
  {
    id: 'reddit',
    label: 'Reddit',
    followUpQuestion: 'Which subreddit?',
    placeholder: 'e.g., r/entrepreneur, r/smallbusiness',
  },
  {
    id: 'facebook',
    label: 'Facebook',
    followUpQuestion: 'Was it a post, group, or ad?',
    placeholder: 'e.g., M&A Professionals group',
  },
  {
    id: 'linkedin',
    label: 'LinkedIn',
    followUpQuestion: "Was it a post, ad, or someone's profile?",
    placeholder: 'e.g., Post from industry expert',
  },
  {
    id: 'youtube',
    label: 'YouTube',
    followUpQuestion: 'Which channel or video?',
    placeholder: 'e.g., Acquisition Lab channel',
  },
  {
    id: 'podcast',
    label: 'Podcast',
    followUpQuestion: 'Which podcast?',
    placeholder: 'e.g., Acquire.com podcast',
  },
  {
    id: 'other',
    label: 'Other',
    followUpQuestion: 'Please specify',
    placeholder: 'e.g., Industry conference, webinar',
  },
] as const;
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="space-y-4">
        <div className="space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            This helps us understand how you found us.
          </p>
        </div>
          ...
          {DEAL_SOURCING_METHOD_OPTIONS.map((option) => {
            ...
            return (
              ...
              >
                ...
                <span className="text-xs font-normal flex-1">{option.label}</span>
              </button>
            );
          })}
        </div>
      ...
      <div className="space-y-4">
        ...
        <Select value={targetAcquisitionVolume} onValueChange={onTargetAcquisitionVolumeChange}>
