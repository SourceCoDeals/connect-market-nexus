      ...
      <div className="min-h-screen flex flex-col items-center justify-center p-4">
        <div className="w-full max-w-lg space-y-6">
          <div className="text-center space-y-3">
            ...
            <h2 id="agreement-gate-title" className="text-2xl font-bold">
              Sign an Agreement to Access Deals
            </h2>
            <p className="text-muted-foreground max-w-md mx-auto">
              Deal details - including the business name, financials, and owner information - are
              confidential. Sign a Fee Agreement to access deal materials and request introductions.
            </p>
          </div>
          ...
          {sent ? (
            <div className="bg-emerald-50 border border-emerald-200 rounded-lg p-6 text-center space-y-3">
              ...
              <p className="text-sm text-emerald-700">
                ...
                signed copy. Once processed, you'll be able to request deal introductions and
                receive deal materials.
              </p>
            </div>
          ) : (
            <>
