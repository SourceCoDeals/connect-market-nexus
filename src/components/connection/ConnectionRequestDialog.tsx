      ...
      >
        ...
        <DialogFooter className="flex-col-reverse sm:flex-row gap-2">
          ...
          <Button
            ...
            className="w-full sm:w-auto bg-gradient-to-r from-sourceco via-sourceco-accent to-sourceco text-slate-900 border-0 hover:shadow-lg hover:shadow-sourceco/20 font-semibold"
          >
