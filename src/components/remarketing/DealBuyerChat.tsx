...
const getExampleQueries = (
  ...
  if (approvedCount === 0 && passedCount === 0) {
    return [
  ...
  if (approvedCount > 0 && pendingCount > 0) {
    return [
      "Are there any other buyers I'm missing?",
      "Compare my approved buyers to remaining options",
      "Which pending buyers should I prioritize?",
    ];
  }
  return [
    "Who should get this deal?",
    "Find buyers with geographic overlap",
    "Show me buyers with recent acquisition activity",
  ];
};
...
export function DealBuyerChat({
  ...
  // Extract buyer IDs from hidden marker
  const extractBuyerIds = useCallback((content: string): string[] => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Extract buyer IDs and notify parent
      const buyerIds = extractBuyerIds(fullContent);
          ...
          {messages.length === 0 && !streamingContent ? (
            <div className="space-y-4">
              <div className="text-center py-6">
                ...
                <p className="text-sm font-medium">Ask me about buyers for this deal</p>
                <p className="text-xs text-muted-foreground mt-1">
                  I'll recommend matches with detailed reasoning
                </p>
              </div>
            ...
            <div className="space-y-4">
              ...
              {isLoading && !streamingContent && (
                <div className="flex items-center gap-2 text-muted-foreground">
                  ...
                  <span className="text-sm">Analyzing buyers...</span>
                </div>
              )}
            </div>
          )}
