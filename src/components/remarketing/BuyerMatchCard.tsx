...
// Get disqualification reason - prefer backend field, fallback to parsing reasoning
const getDisqualificationReason = (disqualificationReason: string | null | undefined, reasoning: string | null): string => {
  if (disqualificationReason) return disqualificationReason;
      ...
      <div className={cn(
        ...
        {disqualified && (
          <div className="mt-3 flex items-center gap-2 text-xs text-red-600">
            ...
            <span>Reason: {getDisqualificationReason(score.disqualification_reason, score.fit_reasoning)}</span>
          </div>
        )}
