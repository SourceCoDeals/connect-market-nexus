...
import { Sparkles, Users, Search, Globe, Link2, CreditCard, Mail } from 'lucide-react';
                    ...
                    return (
                      <AnalyticsTooltip
                        ...
                        rows={[
                          ...
                          {
                            label: 'Conv. Rate',
                            value: `${channel.visitors > 0 ? ((channel.connections / channel.visitors) * 100).toFixed(1) : 0}%`,
                            highlight: true,
                          },
                        ]}
                      >
                        ...
                        >
                          <div className="flex items-center gap-2">
                            <div
                              ...
                              style={{
                                backgroundColor: CHANNEL_COLORS[channel.name] || 'hsl(220 15% 60%)',
                              }}
                            />
                  ...
                  return (
                    <AnalyticsTooltip
                      ...
                      rows={[
                        ...
                        {
                          label: 'Conv. Rate',
                          value: `${ref.visitors > 0 ? ((ref.connections / ref.visitors) * 100).toFixed(1) : 0}%`,
                          highlight: true,
                        },
                      ]}
                    >
                  ...
                  return (
                    <AnalyticsTooltip
                      ...
                      rows={[
                        ...
                        {
                          label: 'Conv. Rate',
                          value: `${campaign.visitors > 0 ? ((campaign.connections / campaign.visitors) * 100).toFixed(1) : 0}%`,
                          highlight: true,
                        },
                      ]}
                    >
                      <ProportionalBar value={getSortValue(campaign)} maxValue={maxCampaignValue}>
                        <div
                          className={cn(
                            'flex items-center justify-between',
                            isActive && 'opacity-50',
                  ...
                  return (
                    <AnalyticsTooltip
                      ...
                      rows={[
                        ...
                        {
                          label: 'Conv. Rate',
                          value: `${kw.visitors > 0 ? ((kw.connections / kw.visitors) * 100).toFixed(1) : 0}%`,
                          highlight: true,
                        },
                      ]}
                    >
                      <ProportionalBar value={getSortValue(kw)} maxValue={maxKeywordValue}>
                        <div
                          className={cn(
                            'flex items-center justify-between',
                            isActive && 'opacity-50',
