...
export const ProportionalBar = forwardRef<HTMLDivElement, ProportionalBarProps>(
  ({ value, maxValue, secondaryValue, secondaryMaxValue, className, children }, ref) => {
    ...
    return (
      <div 
        ref={ref}
        className={cn("relative py-2 -mx-2 px-2 rounded-lg transition-colors hover:bg-muted/20", className)}
      >
...
ProportionalBar.displayName = "ProportionalBar";
