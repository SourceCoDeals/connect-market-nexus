        ...
        <Card className="p-5 border-border/40">
          <div className="grid grid-cols-3 gap-4">
            <div className="text-center">
              <div className="text-2xl font-bold text-foreground">{emailHistory.length}</div>
        ...
        <Card className="p-5 border-border/40">
          {!showCompose ? (
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <h4 className="font-semibold text-sm">Compose Email</h4>
                <Badge variant="outline" className="text-xs border-border/60">
                  To: {deal.contact_email}
                </Badge>
              </div>
        ...
        <div className="space-y-3">
          ...
          {emailHistory.length === 0 ? (
            ...
            emailHistory.map((email) => (
              <Card key={email.id} className="p-4 border-border/40">
                <div className="space-y-3">
                  <div className="flex items-start justify-between">
                    <div className="flex items-start gap-3 flex-1">
                      <div className="text-lg">{getEmailTypeIcon(email.type)}</div>
