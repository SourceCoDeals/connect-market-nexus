          ...
          {collapsed ? (
            <Tooltip>
              ...
              <TooltipContent side="right">
                Search <span className="text-muted-foreground ml-1">⌘K</span>
              </TooltipContent>
            </Tooltip>
          ) : (
            <button
              onClick={onSearchClick}
              className="flex items-center gap-2.5 w-full px-2 py-1.5 text-sm rounded-md text-muted-foreground hover:bg-muted hover:text-foreground transition-colors group"
            >
