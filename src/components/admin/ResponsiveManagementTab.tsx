...
import { EnhancedMobileGestures, MobileQuickAction } from "./EnhancedMobileGestures";
        ...
        <div className="space-y-4">
            ...
            <CardContent className="pt-0">
              <div className="grid grid-cols-1 gap-2">
                <MobileQuickAction
                  ...
                  onClick={() => {
                    setActiveTab("feedback");
                    setActiveQuickAction('respond-feedback');
                  }}
                />
                <MobileQuickAction
                  icon={Plus}
                  ...
                  onClick={() => {
                    setActiveTab("alerts");
                    setActiveQuickAction('create-alert');
                  }}
                />
                <MobileQuickAction
                  icon={Bell}
                  ...
                  onClick={() => {
                    setActiveTab("alerts");
                    setActiveQuickAction('manage-alerts');
                  }}
                />
              </div>
            </CardContent>
          ...
          <Tabs value={activeTab} onValueChange={(value) => setActiveTab(value as any)} className="space-y-4">
            <TabsList className="grid w-full grid-cols-2 h-12">
              <TabsTrigger value="feedback" className="flex items-center gap-2 text-sm touch-manipulation">
              ...
              <TabsTrigger value="alerts" className="flex items-center gap-2 text-sm touch-manipulation">
