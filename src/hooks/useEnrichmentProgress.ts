 ...
 *
 * Polls the enrichment_queue table to track real-time enrichment progress,
 * computes estimated time remaining, and provides pause/resume/cancel controls
 * along with a completion summary.
 *
 * Returns: { progress, summary, showSummary, dismissSummary, pauseEnrichment, resumeEnrichment, cancelEnrichment }
 *
