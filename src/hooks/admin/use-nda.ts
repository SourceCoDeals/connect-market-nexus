...
export const useUpdateNDA = () => {
  ...
  return useMutation({
    ...
    onMutate: async ({ userId, isSigned }) => {
      ...
      type ConnectionRequestEntry = {
        user?: { id: string; nda_signed: boolean; nda_signed_at: string | null };
      };
      ...
      queryClient.setQueryData(
        ['connection-requests'],
        (old: ConnectionRequestEntry[] | undefined) => {
          if (!old) return old;
...
export const useUpdateNDAEmailSent = () => {
  ...
  return useMutation({
    ...
    onMutate: async ({ userId, isSent }) => {
      ...
      type ConnectionRequestEntry = {
        user?: { id: string; nda_email_sent: boolean; nda_email_sent_at: string | null };
      };
