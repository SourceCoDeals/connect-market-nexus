    ...
    <div className="space-y-6 pr-8">
      ...
      <div className="space-y-3">
        ...
        <p className="text-xs text-muted-foreground leading-relaxed">
          We connect business owners with qualified buyers who understand your industry, without the
          public exposure of listing on the open market.
        </p>
        <p className="text-xs text-muted-foreground leading-relaxed">
          Our team will reach out within 1-4 hours to learn about your goals and discuss your
          options, whether you are ready to sell now or just exploring,{' '}
          <span className="font-semibold text-foreground">at no cost to you</span>.
        </p>
      </div>
          ...
          <div className="flex items-start space-x-3">
            ...
            <div className="space-y-1.5 flex-1 relative">
              <blockquote className="text-xs text-foreground leading-relaxed italic">
                "SourceCo's team clearly understood our investment thesis and effectively conveyed
                our value to owners. Their process resulted in multiple LOIs and a closed deal."
              </blockquote>
      ...
      <Card className="border-0 shadow-none bg-transparent">
        ...
        <CardContent className="px-0">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {/* Website (optional) */}
            <div className="space-y-1.5">
              <Label className="text-xs text-muted-foreground">Business Website (optional)</Label>
              <Input
              ...
              {errors.businessWebsite && (
                <p className="text-xs text-destructive">{errors.businessWebsite}</p>
              )}
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="space-y-1.5">
                ...
                {errors.revenueRange && (
                  <p className="text-xs text-destructive">{errors.revenueRange}</p>
                )}
              </div>
              ...
              <div className="space-y-1.5">
                ...
                {errors.saleTimeline && (
                  <p className="text-xs text-destructive">{errors.saleTimeline}</p>
                )}
              </div>
            </div>
