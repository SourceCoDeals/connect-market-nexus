/**
 * AdminLogin — Dedicated internal team login page.
 *
 * Route: /admin-login
 * Provides a separate entry point for internal staff that routes
 * directly to /admin on successful login. This reduces friction
 * for team members who never need to see the marketplace.
 */
  ...
  useEffect(() => {
    if (authChecked && user) {
      if (user.is_admin) {
        ...
        // Not an admin — send to marketplace
          ...
          <Card className="border-none shadow-lg">
            <CardHeader className="space-y-1">
              ...
              <CardDescription className="text-xs text-center">
                Sign in with your team credentials to access the admin panel
              </CardDescription>
            </CardHeader>
            <CardContent>
