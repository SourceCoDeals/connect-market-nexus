...
const SavedListings = () => {
  ...
  const { data: savedListings, isLoading, error } = useSavedListings();

  useEffect(() => {
    document.title = "Saved Listings | Marketplace";
  }, []);
          ...
          <div className="flex flex-col gap-4">
            ...
            {isLoading ? (
              ...
              <div className="bg-muted/30 border border-border rounded-lg p-8 text-center">
                ...
                <p className="text-muted-foreground mb-4">
                  You haven't saved any listings yet. Start browsing the marketplace to save your favorite listings.
                </p>
                <Button asChild>
