...
import {
  ...
  calculateIntelligencePercentage,
} from '@/lib/ma-intelligence/types';
...
import { BuyerTierBadge, PlatformSignalBadge } from '@/components/admin/BuyerFitScoreBadge';
    ...
    return (
      <div className="flex items-center justify-center min-h-[60vh]">
        <div className="text-center">
          ...
          <Button onClick={() => navigate('/admin/ma-intelligence/buyers')}>Back to Buyers</Button>
        </div>
      </div>
    );
  }
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              {buyer.platform_company_name && (
                <p className="text-muted-foreground">PE Firm: {buyer.pe_firm_name}</p>
              )}
            </div>
          </div>
        </div>
        <div className="flex items-center gap-2">
          {buyer.buyer_fit_tier && (
            <BuyerTierBadge tier={buyer.buyer_fit_tier as number} size="md" showLabel />
          )}
          {buyer.platform_signal_detected && (
            <PlatformSignalBadge detected={buyer.platform_signal_detected as boolean} />
          )}
          {buyer.buyer_fit_score != null && (
            <Badge variant="outline" className="font-mono">
              Score: {buyer.buyer_fit_score as number}/100
            </Badge>
          )}
        ...
        <Alert>
          ...
          <AlertDescription className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <Button size="sm" variant="outline" onClick={() => setIsPassDialogOpen(true)}>
          ...
          <CardContent>
            <div className="text-sm">
              ...
              {buyer.acquisition_frequency && (
                <span className="text-muted-foreground ml-1">- {buyer.acquisition_frequency}</span>
              )}
            </div>
          </CardContent>
        </Card>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
        ...
        <TabsContent value="agreements">
          <BuyerAgreementsPanel
            ...
            feeAgreementSource={buyer.fee_agreement_source}
          />
        </TabsContent>
        ...
        <TabsContent value="transcripts">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Call recordings and transcript analysis</CardDescription>
            </CardHeader>
            <CardContent>
