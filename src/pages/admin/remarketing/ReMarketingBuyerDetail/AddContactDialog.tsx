...
interface AddContactDialogProps {
  ...
  onContactChange: (contact: ContactFormData) => void;
  onSubmit: () => void;
  isPending: boolean;
  editMode?: boolean;
}
        ...
        <div className="space-y-4 py-4">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(e) => onContactChange({ ...newContact, mobile_phone_1: e.target.value })}
            />
          </div>
          {showExtraPhones ? (
            <>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => onContactChange({ ...newContact, mobile_phone_2: e.target.value })}
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => onContactChange({ ...newContact, mobile_phone_3: e.target.value })}
                />
              </div>
            </>
          ) : (
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(e) => onContactChange({ ...newContact, office_phone: e.target.value })}
            />
          </div>
          <div className="space-y-2">
