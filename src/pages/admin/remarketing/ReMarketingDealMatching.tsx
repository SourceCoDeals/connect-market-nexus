...
const ReMarketingDealMatching = () => {
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      {/* Stale Score Warning - Shows when deal data changed since last scoring */}
      {listing && scores && scores.length > 0 && scores[0]?.deal_snapshot && (
        <StaleScoreWarning
          dealSnapshot={scores[0].deal_snapshot}
          currentDeal={{
          ...
          onRescore={() => handleBulkScore()}
          isRescoring={isScoring}
        />
      )}
