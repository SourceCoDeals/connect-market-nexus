...
export const THIRTY_Q_SUITE: ThirtyQQuestion[] = [
  ...
  { id: 24, category: 'Content Creation', question: 'Create a deal memo executive summary for a commercial cleaning business', expectedRoute: 'OUTREACH_DRAFT', expectedBehavior: 'Drafts an executive summary section suitable for a deal memo.', autoValidation: { mustContainAny: ['cleaning', 'executive', 'summary', 'memo', 'deal', 'business', 'revenue'], requiresToolCalls: false, minResponseLength: 200, maxResponseTimeMs: 25000 } },
