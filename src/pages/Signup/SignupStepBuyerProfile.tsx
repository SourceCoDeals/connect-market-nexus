    ...
    <div className="space-y-4">
      <div className="space-y-1.5">
        ...
        <Textarea
          ...
          onChange={(e) => setFormData((p) => ({ ...p, idealTargetDescription: e.target.value }))}
        />
      </div>
      ...
      <div className="space-y-1.5">
        ...
        <EnhancedMultiCategorySelect
          ...
          onValueChange={(selected) => setFormData((p) => ({ ...p, businessCategories: selected }))}
      ...
      <div className="space-y-1.5">
        ...
        <EnhancedMultiLocationSelect
          ...
          onValueChange={(selected) => setFormData((p) => ({ ...p, targetLocations: selected }))}
        ...
        <div className="space-y-1.5">
          ...
          <div className="grid grid-cols-2 gap-3">
            <Select
              ...
              onValueChange={(v) => setFormData((p) => ({ ...p, revenueRangeMin: v }))}
            >
              <SelectTrigger>
                <SelectValue placeholder="Select..." />
              </SelectTrigger>
            ...
            <Select
              ...
              onValueChange={(v) => setFormData((p) => ({ ...p, revenueRangeMax: v }))}
            >
              <SelectTrigger>
                <SelectValue placeholder="Select..." />
              </SelectTrigger>
      ...
      <div className="space-y-1.5">
        ...
        <Textarea
          ...
          onChange={(e) => setFormData((p) => ({ ...p, specificBusinessSearch: e.target.value }))}
        />
      </div>

      <div className="space-y-1.5">
        <Label className="text-xs text-muted-foreground">Deal Intent *</Label>
        <RadioGroup
          value={formData.dealIntent || ''}
          onValueChange={(v) => setFormData((p) => ({ ...p, dealIntent: v }))}
          className="space-y-1.5"
        >
          {DEAL_INTENT_OPTIONS.map((o) => (
            <div key={o.value} className="flex items-center space-x-2">
              <RadioGroupItem value={o.value} id={o.value} />
              <Label htmlFor={o.value} className="font-normal cursor-pointer text-xs">
                {o.label}
              </Label>
            </div>
          ))}
      ...
      <div className="space-y-1.5">
        ...
        <ChipInput
          ...
          onChange={(v) => setFormData((p) => ({ ...p, exclusions: v }))}
      ...
      <div className="space-y-1.5">
        ...
        <ChipInput
          ...
          onChange={(v) => setFormData((p) => ({ ...p, includeKeywords: v }))}
