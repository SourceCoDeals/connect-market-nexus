...
export function SignupStepBuyerType({ formData, setFormData, onChange }: Props) {
  const handleBuyerTypeChange = (value: string) => {
    setFormData((prev) => ({
      ...
      owningBusinessUnit: '',
      dealSizeBand: '',
      integrationPlan: [] as string[],
      corpdevIntent: '',
      portfolioCompanyAddon: '',
      deployingCapitalNow: '',
      discretionType: '',
      permanentCapital: false,
      operatingCompanyTargets: [] as string[],
      searchType: '',
      acqEquityBand: '',
      financingPlan: [] as string[],
    ...
    <div className="space-y-4">
        ...
        <div className="space-y-4 pt-2">
          <div className="space-y-1.5">
            ...
            <EnhancedCurrencyInput
              ...
              onChange={(value) => setFormData((p) => ({ ...p, estimatedRevenue: value }))}
              fieldType="revenue"
          ...
          <div className="space-y-1.5">
            ...
            <Select
              ...
              onValueChange={(v) => setFormData((p) => ({ ...p, dealSizeBand: v }))}
            >
              <SelectTrigger>
                <SelectValue placeholder="Select..." />
              </SelectTrigger>
              <SelectContent>
                {DEAL_SIZE_BAND_OPTIONS.map((o) => (
            ...
            <div className="grid grid-cols-2 gap-2">
              {INTEGRATION_PLAN_OPTIONS.map((o) => (
                <div key={o.value} className="flex items-center space-x-2">
                  <Checkbox
                    id={`integration-${o.value}`}
                    checked={(formData.integrationPlan || []).includes(o.value)}
                    onCheckedChange={(checked) => {
                      const c = formData.integrationPlan || [];
                      setFormData((p) => ({
                        ...p,
                        integrationPlan: checked ? [...c, o.value] : c.filter((i) => i !== o.value),
                      }));
                    }}
                  />
                  <Label htmlFor={`integration-${o.value}`} className="text-xs font-normal">
                    {o.label}
                  </Label>
                </div>
              ))}
          ...
          <div className="space-y-1.5">
            ...
            <Select
              ...
              onValueChange={(v) => setFormData((p) => ({ ...p, corpdevIntent: v }))}
            >
              <SelectTrigger>
                <SelectValue placeholder="Select..." />
              </SelectTrigger>
              <SelectContent>
                {CORPDEV_INTENT_OPTIONS.map((o) => (
                  <SelectItem key={o.value} value={o.value}>
                    {o.label}
                  </SelectItem>
                ))}
        ...
        <div className="space-y-4">
          <div className="space-y-1.5">
            ...
            <EnhancedCurrencyInput
              ...
              onChange={(v) => setFormData((p) => ({ ...p, fundSize: v }))}
              fieldType="fund"
              currencyMode="millions"
            />
          </div>
          <div className="space-y-1.5">
            ...
            <InvestmentSizeSelect
              ...
              onValueChange={(v) => setFormData((p) => ({ ...p, investmentSize: v }))}
          ...
          <div className="space-y-1.5">
            ...
            <EnhancedCurrencyInput
              value={formData.aum}
              onChange={(v) => setFormData((p) => ({ ...p, aum: v }))}
              fieldType="aum"
              currencyMode="millions"
            />
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <Select
              ...
              onValueChange={(v) => setFormData((p) => ({ ...p, deployingCapitalNow: v }))}
            >
              <SelectTrigger>
                <SelectValue placeholder="Select..." />
              </SelectTrigger>
              <SelectContent>
                {DEPLOYING_CAPITAL_OPTIONS.map((o) => (
                  <SelectItem key={o.value} value={o.value}>
                    {o.label}
                  </SelectItem>
                ))}
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            <Select
              ...
              onValueChange={(v) => setFormData((p) => ({ ...p, discretionType: v }))}
            >
              <SelectTrigger>
                <SelectValue placeholder="Select..." />
              </SelectTrigger>
              <SelectContent>
                {DISCRETION_TYPE_OPTIONS.map((o) => (
                  <SelectItem key={o.value} value={o.value}>
                    {o.label}
                  </SelectItem>
                ))}
          ...
          <div className="flex items-center space-x-2">
            <Checkbox
              ...
              onCheckedChange={(checked) =>
                setFormData((p) => ({ ...p, permanentCapital: checked as boolean }))
              }
            />
          ...
          <div className="space-y-1.5">
            ...
            <ChipInput
              ...
              onChange={(companies) =>
                setFormData((p) => ({ ...p, operatingCompanyTargets: companies.slice(0, 3) }))
              }
        ...
        <div className="space-y-4">
          <div className="space-y-1.5">
            ...
            <Select
              ...
              onValueChange={(v) => setFormData((p) => ({ ...p, searchType: v }))}
            >
              <SelectTrigger>
                <SelectValue placeholder="Select..." />
              </SelectTrigger>
          ...
          <div className="space-y-1.5">
            ...
            <Select
              ...
              onValueChange={(v) => setFormData((p) => ({ ...p, acqEquityBand: v }))}
            >
              <SelectTrigger>
                <SelectValue placeholder="Select..." />
              </SelectTrigger>
              <SelectContent>
                {ACQ_EQUITY_BAND_OPTIONS.map((o) => (
                  <SelectItem key={o.value} value={o.value}>
                    {o.label}
                  </SelectItem>
                ))}
          ...
          <div className="space-y-1.5">
            ...
            <div className="grid grid-cols-2 gap-2">
              {FINANCING_PLAN_OPTIONS.map((o) => (
                <div key={o.value} className="flex items-center space-x-2">
                  <Checkbox
                    id={`financing-${o.value}`}
                    checked={(formData.financingPlan || []).includes(o.value)}
                    onCheckedChange={(checked) => {
                      const c = formData.financingPlan || [];
                      setFormData((p) => ({
                        ...p,
                        financingPlan: checked ? [...c, o.value] : c.filter((i) => i !== o.value),
                      }));
                    }}
                  />
                  <Label htmlFor={`financing-${o.value}`} className="text-xs font-normal">
                    {o.label}
                  </Label>
                </div>
              ))}
          ...
          <div className="space-y-1.5">
            ...
            <Select
              value={
                formData.flexSub2mEbitda === undefined
                  ? ''
                  : formData.flexSub2mEbitda
                    ? 'yes'
                    : 'no'
              }
              onValueChange={(v) => setFormData((p) => ({ ...p, flexSub2mEbitda: v === 'yes' }))}
            >
              <SelectTrigger>
                <SelectValue placeholder="Select..." />
              </SelectTrigger>
          ...
          <div className="space-y-1.5">
            ...
            <Select
              ...
              onValueChange={(v) => setFormData((p) => ({ ...p, searchStage: v }))}
            >
              <SelectTrigger>
                <SelectValue placeholder="Select..." />
              </SelectTrigger>
              <SelectContent>
                {SEARCH_STAGE_OPTIONS.map((o) => (
                  <SelectItem key={o.value} value={o.value}>
                    {o.label}
                  </SelectItem>
                ))}
        ...
        <div className="space-y-4">
          <div className="space-y-1.5">
            ...
            <Select
              ...
              onValueChange={(v) => setFormData((p) => ({ ...p, fundingSource: v }))}
            >
              <SelectTrigger className="w-full">
                <SelectValue placeholder="Select..." />
              </SelectTrigger>
              <SelectContent>
                {INDIVIDUAL_FUNDING_SOURCE_OPTIONS.map((o) => (
                  <SelectItem key={o.value} value={o.value}>
                    {o.label}
                  </SelectItem>
                ))}
          ...
          <div className="space-y-1.5">
            ...
            <Select
              ...
              onValueChange={(v) => setFormData((p) => ({ ...p, usesBank: v }))}
            >
              <SelectTrigger className="w-full">
                <SelectValue placeholder="Select..." />
              </SelectTrigger>
              <SelectContent>
                {USES_BANK_FINANCE_OPTIONS.map((o) => (
                  <SelectItem key={o.value} value={o.value}>
                    {o.label}
                  </SelectItem>
                ))}
          ...
          <div className="space-y-1.5">
            ...
            <Select
              ...
              onValueChange={(v) => setFormData((p) => ({ ...p, maxEquityToday: v }))}
            >
              <SelectTrigger>
                <SelectValue placeholder="Select..." />
              </SelectTrigger>
              <SelectContent>
                {MAX_EQUITY_TODAY_OPTIONS.map((o) => (
                  <SelectItem key={o.value} value={o.value}>
                    {o.label}
                  </SelectItem>
                ))}
        ...
        <div className="space-y-4">
          <div className="space-y-1.5">
            ...
            <Select
              ...
              onValueChange={(v) => setFormData((p) => ({ ...p, committedEquityBand: v }))}
            >
              <SelectTrigger>
                <SelectValue placeholder="Select..." />
              </SelectTrigger>
              <SelectContent>
                {COMMITTED_EQUITY_BAND_OPTIONS.map((o) => (
                  <SelectItem key={o.value} value={o.value}>
                    {o.label}
                  </SelectItem>
                ))}
          ...
          <div className="space-y-1.5">
            ...
            <div className="grid grid-cols-2 gap-2">
              {EQUITY_SOURCE_OPTIONS.map((o) => (
                <div key={o.value} className="flex items-center space-x-2">
                  <Checkbox
                    id={`equity-source-${o.value}`}
                    checked={(formData.equitySource || []).includes(o.value)}
                    onCheckedChange={(checked) => {
                      const c = formData.equitySource || [];
                      setFormData((p) => ({
                        ...p,
                        equitySource: checked ? [...c, o.value] : c.filter((i) => i !== o.value),
                      }));
                    }}
                  />
                  <Label htmlFor={`equity-source-${o.value}`} className="text-xs font-normal">
                    {o.label}
                  </Label>
                </div>
              ))}
          ...
          <div className="space-y-1.5">
            <Label className="text-xs text-muted-foreground">Flexible on size? *</Label>
            <Select
              value={
                formData.flexSubxmEbitda === undefined
                  ? ''
                  : formData.flexSubxmEbitda
                    ? 'yes'
                    : 'no'
              }
              onValueChange={(v) => setFormData((p) => ({ ...p, flexSubxmEbitda: v === 'yes' }))}
            >
              <SelectTrigger>
                <SelectValue placeholder="Select..." />
              </SelectTrigger>
          ...
          <div className="space-y-1.5">
            ...
            <Select
              ...
              onValueChange={(v) => setFormData((p) => ({ ...p, deploymentTiming: v }))}
            >
              <SelectTrigger>
                <SelectValue placeholder="Select..." />
              </SelectTrigger>
              <SelectContent>
                {DEPLOYMENT_TIMING_OPTIONS.map((o) => (
                  <SelectItem key={o.value} value={o.value}>
                    {o.label}
                  </SelectItem>
                ))}
        ...
        <div className="space-y-4">
          <div className="space-y-1.5">
            ...
            <Select
              ...
              onValueChange={(v) => setFormData((p) => ({ ...p, onBehalfOfBuyer: v }))}
            >
              <SelectTrigger>
                <SelectValue placeholder="Select..." />
              </SelectTrigger>
              <SelectContent>
                {ON_BEHALF_OPTIONS.map((o) => (
                  <SelectItem key={o.value} value={o.value}>
                    {o.label}
                  </SelectItem>
                ))}
            ...
            <>
              <div className="space-y-1.5">
                ...
                <Select
                  ...
                  onValueChange={(v) => setFormData((p) => ({ ...p, buyerRole: v }))}
                >
                  <SelectTrigger>
                    <SelectValue placeholder="Select..." />
                  </SelectTrigger>
                  <SelectContent>
                    {BUYER_ROLE_OPTIONS.map((o) => (
                      <SelectItem key={o.value} value={o.value}>
                        {o.label}
                      </SelectItem>
                    ))}
          ...
          <div className="space-y-1.5">
            <Label className="text-xs text-muted-foreground">
              Mandate in one line (max 140 chars) *
            </Label>
            <Input
              id="mandateBlurb"
              name="mandateBlurb"
      ...
      {formData.buyerType === 'businessOwner' && (
        <div className="space-y-4">
          <div className="space-y-1.5">
            <Label className="text-xs text-muted-foreground">
              Why are you here? (max 140 chars) *
            </Label>
            <Input
              id="ownerIntent"
              name="ownerIntent"
          ...
          <div className="space-y-1.5">
            ...
            <Select
              ...
              onValueChange={(v) => setFormData((p) => ({ ...p, ownerTimeline: v }))}
            >
              <SelectTrigger>
                <SelectValue placeholder="Select..." />
              </SelectTrigger>
              <SelectContent>
                {OWNER_TIMELINE_OPTIONS.map((o) => (
                  <SelectItem key={o.value} value={o.value}>
                    {o.label}
                  </SelectItem>
                ))}
