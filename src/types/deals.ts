 ...
 * deals.ts
 *
 * Shared type definitions for the deal pipeline.
 *
 * Extracted from hooks/admin/use-deals.ts so that both hooks and
 * components can import the types without pulling in hook code.
 */
