 ...
 */
export function formatFieldValue(fieldKey: string, value: string | number | boolean | string[] | null | undefined): string {
 ...
 */
export function formatFieldValueForExport(fieldKey: string, value: string | number | boolean | string[] | null | undefined): string {
  if (value === null || value === undefined || value === '') {
    return '';
  }
 ...
 */
export function getFormattedUserFields(user: Record<string, string | number | boolean | string[] | null | undefined>, _buyerType: string) {
