...
export function createUserObject(profile: any): UserWithDataIssues {
  ...
  const user: UserWithDataIssues = {
    ...
    // Buyer Fit Score
    buyer_fit_score: profile.buyer_fit_score ?? null,
    buyer_fit_tier: profile.buyer_fit_tier ?? null,
    ...
    buyer_fit_score_last_calculated: profile.buyer_fit_score_last_calculated || null,
