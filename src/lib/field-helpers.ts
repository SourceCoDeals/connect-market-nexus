...
export const LOCATION_DESCRIPTIONS = {
  ...
  'Southeast US': 'DE, MD, DC, VA, WV, KY, TN, NC, SC, GA, FL, AL, MS, AR, LA',
  'Southwest US': 'TX, OK, NM, AZ',
  'West Coast US': 'CA, OR, WA, NV',
  'Midwest US': 'OH, MI, IN, IL, WI, MN, IA, MO, ND, SD, NE, KS',
  'Mountain West US': 'MT, ID, WY, CO, UT',
  'Eastern Canada': 'ON, QC, Atlantic provinces',
  'Western Canada': 'MB, SK, AB, BC, territories',
