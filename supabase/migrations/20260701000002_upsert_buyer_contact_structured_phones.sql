-- ============================================================================
-- MIGRATION: Update upsert_buyer_contact and update_buyer_contact for
...
BEGIN
  ...
  SET
    ...
    mobile_phone_1 = CASE WHEN p_mobile_phone_1 IS NOT NULL THEN NULLIF(TRIM(p_mobile_phone_1), '') ELSE mobile_phone_1 END,
    mobile_phone_2 = CASE WHEN p_mobile_phone_2 IS NOT NULL THEN NULLIF(TRIM(p_mobile_phone_2), '') ELSE mobile_phone_2 END,
    mobile_phone_3 = CASE WHEN p_mobile_phone_3 IS NOT NULL THEN NULLIF(TRIM(p_mobile_phone_3), '') ELSE mobile_phone_3 END,
    office_phone   = CASE WHEN p_office_phone IS NOT NULL THEN NULLIF(TRIM(p_office_phone), '') ELSE office_phone END,
    phone_source   = CASE WHEN p_phone_source IS NOT NULL THEN NULLIF(TRIM(p_phone_source), '') ELSE phone_source END,
    updated_at     = now()
