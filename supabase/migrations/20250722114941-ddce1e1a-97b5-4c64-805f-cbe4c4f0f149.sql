...
-- Fix the delete_user_completely function to properly handle audit_logs foreign key constraint
...
BEGIN
  ...
  -- Delete audit logs FIRST (this was causing the constraint violation)
