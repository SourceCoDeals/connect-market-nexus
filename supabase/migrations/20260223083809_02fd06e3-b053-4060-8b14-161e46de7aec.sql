...
BEGIN
  ...
  IF NEW.approval_status = 'approved' AND
    ...
    -- Also check by email domain + universe_id to prevent unique constraint violation
    ...
    IF v_existing_id IS NOT NULL THEN
      -- UPDATE existing buyer — only fill empty fields
    ...
    ELSE
      -- INSERT new buyer, with exception handler for race conditions
      BEGIN
      ...
      EXCEPTION WHEN unique_violation THEN
        -- Duplicate email_domain/universe — just log and continue, don't block approval
