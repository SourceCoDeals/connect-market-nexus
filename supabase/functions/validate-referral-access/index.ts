  ...
  try {
    ...
    if (action === "get-data") {
      ...
      const { data: listings } = await supabase
        .from("listings")
        .select(
          "id, title, internal_company_name, category, revenue, ebitda, full_time_employees, location, status, is_priority_target, website, deal_total_score, main_contact_name, main_contact_title, main_contact_email, main_contact_phone, linkedin_employee_count, linkedin_employee_range"
        )
