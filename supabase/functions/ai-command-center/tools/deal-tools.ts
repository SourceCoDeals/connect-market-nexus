...
async function getDealDetails(
  ...
  if (dealsRow) {
    ...
    if (buyerResult?.data) buyerContact = buyerResult.data;
    if (sellerResult?.data) sellerContact = sellerResult.data;
  }
