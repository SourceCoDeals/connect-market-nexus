    ...
    input_schema: {
      ...
      properties: {
        status: {
          type: 'string',
          description:
            'Filter by deal status. Valid values: "active", "inactive", "pending", "sold". "Active" = deals in the Active Deals pipeline. "Pending" = deals awaiting review (e.g. Pending Referral Review).',
        },
        deal_source: {
          type: 'string',
          description:
