...
const DEAL_FIELDS_FULL = `
  id, title, status, status_label, status_tag, deal_source, industry, industry_tier, industry_tier_name, category, categories,
  revenue, ebitda, ebitda_margin, cash_flow,
  revenue_is_inferred, ebitda_is_inferred,
  ...
  services, service_mix, business_model, end_market_description,
  full_time_employees, part_time_employees, number_of_locations, founded_year,
  deal_total_score, deal_size_score, revenue_score, ebitda_score,
  seller_interest_score, seller_interest_notes, manual_rank_override, scoring_notes,
  is_priority_target, remarketing_status, enrichment_status, acquisition_type,
  key_risks, growth_drivers, growth_trajectory,
  owner_goals, seller_motivation, timeline_preference, timeline_notes,
  seller_involvement_preference, transition_preferences,
  ...
  revenue_model_breakdown, financial_notes, financial_followup_questions,
  market_position, transaction_preferences,
  owner_response, key_quotes, general_notes, special_requirements, tags,
  ...
  deal_owner_id, primary_owner_id, presented_by_admin_id, published_by_admin_id,
  referral_partner_id, is_internal_deal,
  ...
  captarget_contact_date, captarget_call_notes, pushed_to_all_deals, captarget_sheet_tab,
  fireflies_url,
