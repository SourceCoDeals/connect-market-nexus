/**
 * SHARED BUYER CRITERIA EXTRACTION MODULE
 *
 * This module contains the core logic for extracting buyer criteria from M&A guides.
 * It is used by both:
 * - extract-buyer-criteria (direct API endpoint)
 * - extract-buyer-criteria-background (background processing)
 *
 * This shared module eliminates the need for HTTP calls between edge functions.
 */
 ...
 *
 * @param guideContent - Full text content of the M&A guide
 * @param industryName - Name of the industry for context
 * @returns Structured buyer criteria with confidence scores
 */
export async function extractCriteriaFromGuide(
  guideContent: string,
  industryName: string
