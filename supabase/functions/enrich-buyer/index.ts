...
const VALID_BUYER_COLUMNS = new Set([
  ...
  'min_ebitda', 'max_ebitda', 'ebitda_sweet_spot',
      ...
      function: {
        ...
        parameters: {
          ...
          properties: {
            ...
            // Deal Structure
            min_revenue: { type: 'number', description: 'Minimum target revenue in dollars (e.g., 5000000 for $5M)' },
            max_revenue: { type: 'number', description: 'Maximum target revenue in dollars' },
            revenue_sweet_spot: { type: 'number', description: 'Preferred/ideal revenue level in dollars' },
            min_ebitda: { type: 'number', description: 'Minimum target EBITDA in dollars' },
            max_ebitda: { type: 'number', description: 'Maximum target EBITDA in dollars' },
