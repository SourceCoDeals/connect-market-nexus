...
const handler = async (req: Request): Promise<Response> => {
  ...
  try {
    ...
    const { connection_request_id, message_preview, admin_name }: NewMessageNotificationRequest =
      await req.json();
    ...
    const htmlContent = buildMessageNotificationHtml(
      buyerName,
      dealTitle,
      preview,
      loginUrl,
