...
function buildDataRoomEmailHtml(projectName: string, buyerName: string, dataRoomUrl: string): string {
  return `<!DOCTYPE html>
...
<body>
  <div class="header"><h1>Data Room Access — Project ${projectName}</h1></div>
  <div>
    <p>Hi ${buyerName},</p>
